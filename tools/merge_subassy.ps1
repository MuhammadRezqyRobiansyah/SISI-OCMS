# Gabungkan checksheet inspeksi SUB ASSY (DISASSY + MEASURE saja)
# menjadi 1 workbook multi-tab per engine model.
# Hanya sheet yang relevan untuk model tsb yang diambil.
...
$models = @(
    @{
        Out = 'SUBASSY INSPECTION ENGINE SA12V140E-1 (WA800-3).xlsx'
        Sheets = @(
    ...
    @{
        Out = 'SUBASSY INSPECTION ENGINE SA6D140E-2 (GD825A).xlsx'
        Sheets = @(
    ...
    @{
        Out = 'SUBASSY INSPECTION ENGINE SAA12V140E-3 (PC2000-8).xlsx'
        Sheets = @(
    ...
    @{
        Out = 'SUBASSY INSPECTION ENGINE SAA6D140E-5 (D155).xlsx'
        Sheets = @(
    ...
    @{
        Out = 'SUBASSY INSPECTION ENGINE SAA6D170E-5 (D375-6 PC1250-8).xlsx'
        Sheets = @(
            ...
            @{ File = "$base\SAA6D170E-5\SUB ASSY\TURBOCHARGER\DISSASEMBLY\003.TURBO CHARGER_Disassembly check sheet REV 4.xls"; Sheet = 'Turbocharger Dissaasy'; As = 'TURBO DISASSY' },
